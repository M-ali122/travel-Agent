                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: ShapeDecoration(
                            color: controller.isInterestSelected(0) ? Color(0xFF30879B) : Colors.transparent,
                            shape: RoundedRectangleBorder(
                              side: BorderSide(width: 1, color: Color(0xFF30879B)),
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                            decoration: ShapeDecoration(
                              color: controller.isInterestSelected(1) ? Color(0xFF30879B) : Colors.transparent,
                              shape: RoundedRectangleBorder(
                                side: BorderSide(width: 1, color: Color(0xFF30879B)),
                                borderRadius: BorderRadius.circular(40),
                              ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                          decoration: ShapeDecoration(
                            color: controller.isInterestSelected(2) ? Color(0xFF30879B) : Colors.transparent,
                            shape: RoundedRectangleBorder(
                              side: BorderSide(width: 1, color: Color(0xFF30879B)),
                              borderRadius: BorderRadius.circular(40),
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                            ...
                            child: Container(
                              ...
                              padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                              decoration: ShapeDecoration(
                                color: controller.isInterestSelected(3) ? Color(0xFF30879B) : Colors.transparent,
                                shape: RoundedRectangleBorder(
                                  side: BorderSide(width: 1, color: Color(0xFF30879B)),
                                  borderRadius: BorderRadius.circular(40),
                                ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                          decoration: ShapeDecoration(
                            color: controller.isInterestSelected(4) ? Color(0xFF30879B) : Colors.transparent,
                            shape: RoundedRectangleBorder(
                              side: BorderSide(width: 1, color: Color(0xFF30879B)),
                              borderRadius: BorderRadius.circular(40),
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                            ...
                            child: Container(
                              ...
                              padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                              decoration: ShapeDecoration(
                                color: controller.isInterestSelected(6) ? Color(0xFF30879B) : Colors.transparent,
                                shape: RoundedRectangleBorder(
                                  side: BorderSide(width: 1, color: Color(0xFF30879B)),
                                  borderRadius: BorderRadius.circular(40),
                                ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                          decoration: ShapeDecoration(
                            color: controller.isInterestSelected(7) ? Color(0xFF30879B) : Colors.transparent,
                            shape: RoundedRectangleBorder(
                              side: BorderSide(width: 1, color: Color(0xFF30879B)),
                              borderRadius: BorderRadius.circular(40),
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 13),
                            decoration: ShapeDecoration(
                              color: controller.isInterestSelected(8) ? Color(0xFF30879B) : Colors.transparent,
                              shape: RoundedRectangleBorder(
                                side: BorderSide(width: 1, color: Color(0xFF30879B)),
                                borderRadius: BorderRadius.circular(40),
                              ),
