...
class HomeView extends GetWidget<ManagerRequestController> {
  ...
  var arrColor = [
    const Color(0xff9BCFDB),
    const Color(0xffFBE8AC),
    const Color(0xff82D6A6)
  ];
  var arrTime = [
    '08:00',
    '10:00',
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                                fontSize: 10.78, color: DarkTheme.primary),
                          )
                        ],
                      ),
                    ),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final currentDate = request.currentTime != null
                                    ? DateFormat('yyyy-MM-dd hh:mm a')
                                        .format(request.currentTime!.toDate())
                                    : 'Unknown';

                                final departureDate = request.departureDate !=
                                        null
                                    ? DateFormat('yyyy-MM-dd hh:mm a')
                                        .format(request.departureDate!.toDate())
                                    : '$currentDate';
                                ...
                                if (reqlist.requestStatus == "Accepted") {
                                  if (reqlist.type == 'RecomdationRequest') {
                                    Timestamp timestamp =
                                        reqlist.recommendation.depDate;
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${recommendation?.title ?? '${controller.reqList[index].type}'}',
