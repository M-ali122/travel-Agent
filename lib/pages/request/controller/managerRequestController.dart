    ...
    try {
      ...
      if (res.docs.isNotEmpty) {
        ...
        res.docs.forEach((element) {
          ...
          if(element.data()['type'] == "RecomdationRequest"){

            Timestamp timestamp = element.data()["requestDetail"]["depDate"];
          ...
          }else if(element.data()['type'] == "TravelRequest"){
            Timestamp timestamp = element.data()["departureDate"];
            ...
            if (departureDate.year == today.year &&
              ...
              priorityToday += 1;
            } else if (departureDate.isAfter(today)) {
              todoTask += 1;
            } else {
              element.reference.update({
                "requestStatus": "Completed"
            ...
            Timestamp timestamp = element.data()["currentTime"];
            DateTime currentTime = timestamp.toDate();

            if (currentTime.year == today.year &&
              ...
              priorityToday += 1;
            } else if (currentTime.isAfter(today)) {
              todoTask += 1;
            } else {
              element.reference.update({
                "requestStatus": "Completed"
