...
class CancellScreen extends GetWidget<ManagerRequestController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ManagerRequestController>(
      ...
      builder: (controller) {
        return Scaffold(
          body: controller.reqList.isEmpty || !controller.reqList.any((element) => element.requestStatus == 'Cancelled') ?
          const Center(child: Text('Cancel Data not found'),)
              : ListView.builder(
                shrinkWrap: true,
